const express = require("express")//aqui estou ini9ciando o express
const router = express.Router()//aqui estou configurando a primeira parte da rota

const cors = require('cors')//aqui estou trazendo o pacote cors que permite consumir essa api no front-end

const conectaBancoDeDados = require('./bancoDeDados')//aqui estou ligando ao arquivo bancoDeDadod

conectaBancoDeDados()//estou chamando a funcão que conecta o banco de dados
...
app.use(router.post('/mulheres', criaMulher))//congigurei rota POST /mulheres
